...
from graph_repository.workers.common.GraphTypes import NodeTypes, EdgeTypes, REG_NAME, NODE_ID, D_NAME
...
class RegistrantWorker(EditWorker):
    ...
    def _submit_edges(self) -> None:
        ...
        query_params = {
            ...
            Neo4jDBDriver.E_MATCH1: REG_NAME,
    ...
    def _find_registrants_in_graph(self, registrants: set[str]) -> None:
        ...
        if ids == 1:
            ...
            for cnt in range(len_miss_reg):
                self._registrants_to_create.append({REG_NAME: missing_registrants[cnt], NODE_ID: ids[cnt]})
